package net.moxnate.wekkonmod.block.custom;
...
public class MagicBlock extends Block {
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        tooltip.add(Text.translatable("tooltip.wekkonmod.magic_block.tooltip"));
        tooltip.add(Text.translatable("tooltip.wekkonmod.magic_block.tooltip.1"));
